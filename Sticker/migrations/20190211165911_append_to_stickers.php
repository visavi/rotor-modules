...
class AppendToStickers extends AbstractMigration
{
    ...
    {
        $categories = array_map('basename', glob(APP . '/Modules/Sticker/images/*', GLOB_ONLYDIR));
        ...
        foreach ($categories as $categoryName) {
            ...
            $stickers = array_map('basename', glob(APP . '/Modules/Sticker/images/' . $categoryName . '/*.{gif,png,jpg,jpeg}', GLOB_BRACE));
