...
<form method="post" action="{{ route('rating.settings.update') }}">
    ...
    <div class="mb-3{{ hasError('sets[editratingpoint]') }}">
        ...
        <input type="number" class="form-control" id="editratingpoint" name="sets[editratingpoint]" maxlength="4" value="{{ old('sets.editratingpoint', $settings['editratingpoint']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[ratinglist]') }}">
        ...
        <input type="number" class="form-control" id="ratinglist" name="sets[ratinglist]" maxlength="2" value="{{ old('sets.ratinglist', $settings['ratinglist']) }}" required>
