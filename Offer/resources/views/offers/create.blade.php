...
@section('title', __('offer::offers.adding_record'))

@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/"><i class="fas fa-home"></i></a></li>
            <li class="breadcrumb-item"><a href="{{ route('offers.index') }}">{{ __('offer::offers.section') }}</a></li>
...
@section('content')
    ...
    @else
        {{ showError(__('offer::offers.condition_add', ['point' => plural(setting('addofferspoint'), setting('scorename'))])) }}
    @endif
@stop
