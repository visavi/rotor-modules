...
@section('title', __('offer::offers.editing_record'))
...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.offers.index', ['type' => $offer->type]) }}">{{ __('offer::offers.section') }}</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.offers.view', ['id' => $offer->id]) }}">{{ $offer->title }}</a></li>
            <li class="breadcrumb-item active">{{ __('offer::offers.editing_record') }}</li>
        </ol>
    </nav>
@stop
    ...
    <div class="section-form mb-3 shadow">
        <form action="{{ route('admin.offers.edit', ['id' => $offer->id]) }}" method="post">
            ...
            <div class="mb-3{{ hasError('type') }}">
                <label for="type" class="form-label">{{ __('offer::offers.i_want_to') }}</label>
