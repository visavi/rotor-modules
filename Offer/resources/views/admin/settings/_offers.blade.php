...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.modules.module', ['module' => 'Offer']) }}">{{ __('admin.modules.module') }} {{ __('offer::offers.section') }}</a></li>
...
<form method="post">
    ...
    <div class="form-check form-switch mb-3">
        ...
        <input type="checkbox" role="switch" class="form-check-input" value="1" name="sets[feed_offers_show]" id="feed_offers_show"{{ ! empty($settings['feed_offers_show']) ? ' checked' : '' }}>
