...
return new class extends Migration {
    ...
    {
        if (Schema::getColumnType('templates', 'created_at') === 'datetime') {
            return;
        }
        ...
        Schema::table('templates', fn (Blueprint $table) => $table->renameColumn('created_at_dt', 'created_at'));
        Schema::table('templates', fn (Blueprint $table) => $table->index('created_at'));
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('templates', fn (Blueprint $table) => $table->renameColumn('created_at_int', 'created_at'));
        Schema::table('templates', fn (Blueprint $table) => $table->index('created_at'));
    }
};
