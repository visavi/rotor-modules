...
@section('title', __('style_editor::editor.css_js_editor'))
...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('style_editor::editor.css_js_editor') }}</li>
        </ol>
    </nav>
@stop
        ...
        <form action="{{ route('admin.editor.save') }}" method="post">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="tab-css">
                    <div class="mb-1 text-muted small">{{ __('style_editor::editor.css_hint') }}</div>
                ...
                <div class="tab-pane fade" id="tab-js">
                    <div class="mb-1 text-muted small">{{ __('style_editor::editor.js_hint') }}</div>
