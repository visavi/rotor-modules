...
return [
    ...
    'upload_file'               => 'Файл',
    'upload'                    => 'Загрузить',
    'upload_hint'               => 'Загрузить можно и то, что редактор не открывает: картинки, шрифты и иконки. Размер файла — не больше :size',
    'file_success_deleted'      => 'Файл успешно удален!',
    'directory_success_deleted' => 'Директория успешно удалена!',
    'module_directory_protected' => 'Каталог модуля удаляется и переименовывается в админке модулей!',
    ...
    'override_orphan'     => 'Файл ничего не переопределяет: оригинала с таким именем не существует',
