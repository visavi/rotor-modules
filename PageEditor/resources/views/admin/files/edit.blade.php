...
@section('title', __('page_editor::files.file_editing') . ' ' . $path . $file . '.blade.php')
...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            @endif
            <li class="breadcrumb-item active">{{ __('page_editor::files.file_editing') }}</li>
        </ol>
    </nav>
@stop
    ...
    <div class="section-form mb-3 shadow">
        <form method="post">
            ...
            <div class="mb-3{{ hasError('msg') }}">
                ...
                <textarea class="form-control" rows="25" id="msg" name="msg">{{ old('msg', $contest) }}</textarea>
