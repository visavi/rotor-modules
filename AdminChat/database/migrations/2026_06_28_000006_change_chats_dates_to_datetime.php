...
return new class extends Migration {
    ...
    {
        if (Schema::getColumnType('chats', 'created_at') === 'datetime') {
            return;
        }
        ...
        $this->convert('chats', ['created_at', 'updated_at'], static fn ($r) => [
        ...
        Schema::table('chats', fn (Blueprint $table) => $table->index('created_at'));
    }
