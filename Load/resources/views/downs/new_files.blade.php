...
@section('title', sprintf('%s - %s (%s)', __('load::loads.loads'), __('load::loads.new_downs'), __('main.page_num', ['page' => $downs->currentPage()])))

@section('header')
    <h1>{{ __('load::loads.new_downs') }}</h1>
@stop
...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('load::loads.new_downs') }}</li>
        </ol>
    </nav>
@stop
