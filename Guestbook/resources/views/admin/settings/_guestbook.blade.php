...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('guestbook::guestbook.settings') }}</li>
        </ol>
    </nav>
@stop
...
@section('content')
    <form method="post" action="{{ route('guestbook.settings.update') }}">
        ...
        <div class="mb-3">
            <label for="guestbook_text_min" class="form-label">{{ __('guestbook::guestbook.guestbook_text_length') }}:</label>
            ...
            <div class="invalid-feedback d-block">
                <div>{{ textError('sets[guestbook_text_min]') }}</div>
