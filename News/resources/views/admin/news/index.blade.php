...
@section('content')
    @if ($news->isNotEmpty())
            ...
            <div class="section mb-3 shadow">
                <div class="section-header d-flex align-items-start">
                    ...
                    <div class="text-end">
                        ...
                        <form action="{{ route('admin.news.delete', ['id' => $data->id]) }}" method="post" class="d-inline" onsubmit="return confirm('{{ __('news::news.confirm_delete') }}')">
                            @csrf
                            @method('DELETE')
        ...
        {{ __('news::news.total_news') }}: <b>{{ $news->count() }}</b><br><br>
    @else
        {{ showError(__('news::news.empty_news')) }}
    @endif
