...
<form action="{{ route('forum.settings.update') }}" method="post">
    ...
    <div class="mb-3">
        <label for="forum_title_min" class="form-label">{{ __('forum::forums.forum_title_length') }}:</label>
    ...
    <div class="mb-3">
        <label for="forum_note_min" class="form-label">{{ __('forum::forums.forum_note_length') }}:</label>
        <div class="d-flex gap-2">
    ...
    <div class="mb-3">
        <label for="forum_text_min" class="form-label">{{ __('forum::forums.forum_text_length') }}:</label>
        <div class="d-flex gap-2">
    ...
    <div class="mb-3">
        <label for="forum_category_min" class="form-label">{{ __('forum::forums.forum_category_length') }}:</label>
        <div class="d-flex gap-2">
    ...
    <div class="mb-3">
        <label for="forum_description_min" class="form-label">{{ __('forum::forums.forum_description_length') }}:</label>
        <div class="d-flex gap-2">
