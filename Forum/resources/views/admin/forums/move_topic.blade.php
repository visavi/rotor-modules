...
@section('title', __('forum::forums.title_move_topic') . ' ' . $topic->title)
...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('forum::forums.title_move_topic') }} {{ $topic->title }}</li>
        </ol>
    </nav>
@stop
    ...
    <div class="section-form mb-3 shadow">
        <form action="{{ route('admin.topics.move', ['id' => $topic->id]) }}" method="post">
            ...
            <div class="mb-3{{ hasError('fid') }}">
                <label for="fid" class="form-label">{{ __('forum::forums.forum') }}:</label>
