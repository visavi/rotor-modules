...
<form method="post" action="{{ route('board.settings.update') }}">
    ...
    <div class="form-check form-switch mb-3">
        ...
        <input type="checkbox" role="switch" class="form-check-input" value="1" name="sets[boards_create]" id="boards_create"{{ old('sets.boards_create', $settings['boards_create']) ? ' checked' : '' }}>
    ...
    <div class="mb-3{{ hasError('sets[boards_period]') }}">
        ...
        <input type="number" class="form-control" id="boards_period" name="sets[boards_period]" min="1" value="{{ old('sets.boards_period', $settings['boards_period']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[boards_per_page]') }}">
        ...
        <input type="number" class="form-control" id="boards_per_page" name="sets[boards_per_page]" maxlength="2" value="{{ old('sets.boards_per_page', $settings['boards_per_page']) }}" required>
