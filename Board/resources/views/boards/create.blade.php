...
@section('title', __('board::boards.create_item'))
...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('board::boards.create_item') }}</li>
        </ol>
    </nav>
@stop
...
@section('content')
    <form action="{{ route('items.create') }}" method="post">
        ...
        <p class="text-muted fst-italic">
            {{ __('board::boards.boards_period_days', ['days' => setting('boards_period')]) }}
        </p>
