---
git: 51911f1c9faa2a795989a3aedb01378d12817e5c
---
...
Чтобы проверить функцию или взаимодействовать с ней в глобальной области независимо от настроенного обработчика области по умолчанию, используйте метод `globally`. Это удобно для функций, действующих во всем приложении, например для временного включения режима обслуживания или развертывания функции сразу для всех пользователей:
