...
При создании приложения не нужно выбирать исключительно между Gates (шлюзами) и Policies (политиками). В большинстве приложений используется их сочетание, и это совершенно нормально. Gates лучше подходят для действий, не связанных с определенной моделью или ресурсом, например для просмотра панели администратора. Policies следует использовать для авторизации действий над конкретной моделью или ресурсом.
