---
git: 387eeee21a05f89372c46dfb0cb0e66a500edf56
---
...
Использование драйвера `database` — это самый быстрый способ начать работу с Laravel Scout. Драйвер будет использовать полнотекстовые индексы MySQL/PostgreSQL и условия "where like" при фильтрации результатов из вашей существующей базы данных для определения применимых результатов поиска для вашего запроса.
