...
@section('title', __('transfer::transfers.cash_transactions'))
...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('transfer::transfers.cash_transactions') }}</li>
        </ol>
    </nav>
@stop
        ...
        @foreach ($transfers as $data)
            <div class="section mb-3 shadow">
                ...
                <div class="section-user d-flex align-items-start">
                    ...
                    <div class="text-end">
                        <a href="/admin/transfers/view?user={{ $data->user->login }}">{{ __('transfer::transfers.all_transfers') }}</a>
                    </div>
                </div>
