...
<form method="post" action="{{ route('transfer.settings.update') }}">
    ...
    <div class="mb-3{{ hasError('sets[sendmoneypoint]') }}">
        ...
        <input type="number" class="form-control" id="sendmoneypoint" name="sets[sendmoneypoint]" maxlength="4" value="{{ old('sets.sendmoneypoint', $settings['sendmoneypoint']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[listtransfers]') }}">
        ...
        <input type="number" class="form-control" id="listtransfers" name="sets[listtransfers]" maxlength="2" value="{{ old('sets.listtransfers', $settings['listtransfers']) }}" required>
