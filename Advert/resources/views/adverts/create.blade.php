...
@section('title', __('advert::adverts.create_advert'))
...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('advert::adverts.create_advert') }}</li>
        </ol>
    </nav>
@stop
        ...
        <form method="post" action="/adverts/create">
            ...
            <div class="col-sm-4 mb-3{{ hasError('color') }}">
                ...
                <div class="input-group">
                    <input type="text" name="color" class="form-control colorpicker js-color" id="color" maxlength="7" value="{{ $color }}" placeholder="{{ __('advert::adverts.color') }}">
            ...
            <button class="btn btn-primary">{{ __('advert::adverts.buy_for') }} <span class="js-price">{{ setting('rekuserprice') }}</span></button>
        </form>
    </div>
