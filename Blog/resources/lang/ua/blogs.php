...
return [
    ...
    'categories_success_sorted'   => 'Порядок розділів успішно збережено!',
    ...
    'settings_blog_money'           => 'Монети за статтю',
    'settings_blogs_publish'        => 'Дозволити публікацію блогів',
    'settings_blog_moderation'      => 'Увімкнути модерацію статей',
    'settings_blog_title_length'    => 'Довжина заголовка статті (мін/макс)',
    'settings_blog_text_length'     => 'Довжина тексту статті (мін/макс)',
    'settings_blog_tag_length'      => 'Довжина тегу (мін/макс)',
