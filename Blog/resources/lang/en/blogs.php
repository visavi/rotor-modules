...
return [
    ...
    'categories_success_sorted'   => 'Sections order saved successfully!',
    ...
    'settings_blog_money'           => 'Money per article',
    'settings_blogs_publish'        => 'Allow blog publishing',
    'settings_blog_moderation'      => 'Enable article moderation',
    'settings_blog_title_length'    => 'Article title length (min/max)',
    'settings_blog_text_length'     => 'Article text length (min/max)',
    'settings_blog_tag_length'      => 'Tag length (min/max)',
