...
@section('title', __('blog::blogs.tag_cloud'))
...
@section('breadcrumb')
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ __('blog::blogs.tag_cloud') }}</li>
        </ol>
    </nav>
@stop
...
@section('content')
    ...
    @else
        <div class="alert alert-danger">{{ __('blog::blogs.empty_tag_cloud') }}</div>
    @endif
@stop
