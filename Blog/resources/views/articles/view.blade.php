...
@section('content')
    ...
    <div class="section mb-3 shadow">
        ...
        <div class="d-flex align-items-center gap-1">{{ __('main.rating') }}:
    ...
    <div class="section mb-3 shadow p-0 overflow-hidden" id="comments">
        ...
        <div class="px-3">
            ...
            @foreach ($comments as $comment)
                @include('app/_comment_item', ['action' => route('articles.add-comment', ['id' => $article->id]), 'closed' => $article->closed, 'ownerId' => $article->user_id])
            @endforeach
        </div>
    </div>
@stop
