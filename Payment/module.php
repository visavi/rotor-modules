...
return [
    'name'        => 'Платежи',
    'description' => 'Приём платежей через YooKassa: заказы, статусы оплаты и покупка платной рекламы',
    'info'        => <<<'INFO'
...
INFO,
    ...
    'actions'  => [
        '/admin/orders'           => 'payment::payments.orders',
        '/admin/payment-settings' => 'payment::payments.settings',
    ],
];
