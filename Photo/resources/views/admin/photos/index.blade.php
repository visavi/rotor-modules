...
@section('title', __('photo::photos.photos'))
            ...
            <div class="section mb-3 shadow">
                <div class="section-header d-flex align-items-start">
                    ...
                    <div class="text-end">
                        ...
                        <a href="{{ route('admin.photos.delete', ['id' => $photo->id, 'page' => $photos->currentPage()]) }}" onclick="return confirm('{{ __('photo::photos.confirm_delete_photo') }}')" data-bs-toggle="tooltip" title="{{ __('main.delete') }}"><i class="fas fa-times text-muted"></i></a>
                    </div>
                </div>
